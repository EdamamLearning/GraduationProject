...
import ru.edamamlearning.graduationproject.utils.extensions.argument
...
class MessageDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog =
        AlertDialog.Builder(context, R.style.Theme_GraduationProject).apply {
            setTitle(title)
            setMessage(message)
            setPositiveButton(
                positiveText ?: getString(R.string.error_dialog_positive_button_ok)
            ) { _, _ ->
